...
<body>
    <div class="container" id="app">
        <h1 class="text-center mt-4">Instalar Websockets Chat</h1>
        <div class="card mt-4">
            ...
            <div v-if="connected === true" class="card-body">
              ...
              <form>
                ...
                <div class="row text-right mt-2">
                  ...
                  <div class="col-lg-2">
                    <button type="button" v-on:click="sendMessage()" class="btn btn-small btn-primary w-100">Send Message</button>
                  </div>
                </div>
              </form>
            </div>
